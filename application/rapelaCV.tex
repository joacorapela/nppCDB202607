...
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt, parsep=1pt]
    \item Develops, optimizes, and maintains open-source implementations of state-of-the-art machine learning algorithms for probabilistic inference in high-dimensional neural and behavioral time series (e.g., \href{https://github.com/joacorapela/svGPFA}{svGPFA}, \href{https://github.com/joacorapela/ssm}{Linear Dynamical Systems}) utilizing Python, JAX, PyTorch, and Plotly.
    ...
    \item Secured grant funding, directed the hiring process, and managed a small team of research software engineers to execute the BBSRC-funded project \href{https://gtr.ukri.org/projects?ref=BB\%2FW019132\%2F1}{Machine Intelligence for Neuroscience Experimental Control}.
    ...
    \item Collaborates with experimental neuroscientists at the SWC on advanced statistical methods for characterizing neural and behavioural recordings.
    \item Co-develops the data analytic pipeline for the \href{https://www.biorxiv.org/content/10.1101/2025.07.31.664513v1}{Aeon platform}, enabling storage, management, visualization, and high-throughput statistical analysis of continuous (24/7) behavioral and electrophysiological mouse datasets.
...
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt, parsep=1pt]
    ...
    \item Discovered stereotypical, discrete states across pre-ictal, ictal,
        and post-ictal periods of seizures occurring more than an hour apart,
        by applying hidden Markov models to layer 2/3 cortical micro-electrode
        array recordings from epilepsy patients.

    \item Extracted two-dimensional descriptors of high-dimensional
        electrophysiological recordings from patients with epilepsy that
        robustly separate functional ictal periods using t-SNE, XGBoost, and
        manifold learning.
...
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt, parsep=1pt]
    ...
    \item Developed the Volterra Relevant Space Technique (VRST) for the
        estimation of spatial Volterra models of visual cells.
    \item Developed the extended Projection Pursuit Regression (ePPR) algorithm
        for spatio-temporal characterization of visual cells.
\end{itemize}
...
\textbf{University College London} (Course Organizer and Instructor) \hfill 2019---2025 \\
\sectionleft{Experience}%
...
Course organizer and instructor for \href{https://github.com/joacorapela/neuroinformatics24}{Neuroinformatics for SWC PhD Students} (2024). \\
Course organizer and instructor for \href{https://github.com/joacorapela/statNeuro2025}{Statistical Neuroscience for SWC PhD Students} (2025).
