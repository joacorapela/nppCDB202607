...
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt, parsep=1pt]
    ...
    \item Collaborates with experimental neuroscientists at the SWC on advanced statistical methods for characterizing neural populations electrophysiological recordings.
