...
I followed a non-traditional career path. After completing my PhD and two
postdocs researching at the interface between statistical machine learning and
neuroscience, and publishing several papers in prestigious computational
neuroscience journals (e.g., Neural Computation, Network Computations in Neural
Systems, Journal of Vision), I joined the Gatsby Unit and the SWC as a research
engineer fellow.
...
\paragraph{Advanced computational skills relevant to neuroscience research, including proﬁciency
in at least one scientiﬁc programming language (e.g. Python, MATLAB, R, Julia) and
...
\paragraph{Postgraduate Certiﬁcate in Teaching \& Learning in Higher Education, or equivalent
qualiﬁcation.}
